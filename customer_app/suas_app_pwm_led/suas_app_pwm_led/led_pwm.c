...
void task_led_pwm([[gnu::unused]] void *pvParameters)
{
  ...
  suas_pwm_conf_t conf = {
    .pin = 17, // Pin of the GPIO pin to use
    .frequency = 2048, // Frequency to set (must be between 2,000 and 800,000)
    .frequency_divider = 4, // Set a frequency divider.
                            // The actual frequency will be frequency/frequency_divider = 2048/4 = 512
